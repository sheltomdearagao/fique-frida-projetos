...
export default function ProductCarousel({
  ...
  return <div className="relative group mb-8 lg:mb-12">
      ...
      }} className="flex gap-2 lg:gap-4 overflow-x-auto hide-scrollbar px-4 lg:px-8 pb-4 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-6 py-[95px]">
          {products.map(product => <div key={product.id} onClick={() => onProductClick(product)} className="flex-none w-[85vw] md:w-auto bg-gray-900/95 rounded-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:z-10 hover:shadow-2xl hover:shadow-frida-magenta/20 group/card">
              {/* Imagem do Produto */}
